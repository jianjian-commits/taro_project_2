...
import { EditorStockOut } from 'gm-printer'
...
class TemEditor extends React.Component {
  ...
  handleSave = (config, isSaveAs) => {
    ...
    if (template_id && !isSaveAs) {
      ...
      Request('/fe/stock_out_tpl/create')
        .data({ content: req })
        .post()
        .then(() => {
