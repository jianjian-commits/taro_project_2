...
import { EditorSettle } from 'gm-printer'
...
class TemEditor extends React.Component {
  ...
  render() {
    ...
    const { permission } = this.props.global.user
    const canEdit = _.includes(permission, 'edit_print_template_new')
